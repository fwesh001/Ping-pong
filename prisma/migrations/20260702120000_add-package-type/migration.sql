-- Migration: add-package-type
-- This migration mirrors the manual ALTERs applied to production so Prisma
-- migration history can be brought into sync without resetting the database.
...
-- Populate `type` from existing ids
...
-- (Optional) Ensure known slot counts / premium tiers are set for seeded rows
...
-- Example premium population (adjust if your seed differs)
