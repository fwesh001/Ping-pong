...
CREATE TABLE "new_Monitor" (
    ...
    "executeTime" TEXT NOT NULL DEFAULT '',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Monitor_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Monitor" ("costPerPing", "createdAt", "endsAt", "id", "isActive", "isCompleted", "isOneOff", "lastPingedAt", "pingIntervalSecs", "serviceName", "startsAt", "targetUrl", "timeoutMs", "updatedAt", "userId") SELECT "costPerPing", "createdAt", "endsAt", "id", "isActive", "isCompleted", "isOneOff", "lastPingedAt", "pingIntervalSecs", "serviceName", "startsAt", "targetUrl", "timeoutMs", "updatedAt", "userId" FROM "Monitor";
DROP TABLE "Monitor";
